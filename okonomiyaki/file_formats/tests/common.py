...
DUMMY_PKG_VALID_EGG = os.path.join(DATA_DIR, 'dummy_pkg_valid_pyc-0.1.0-py3.6.egg')
DUMMY_PKG_STALE_EGG = os.path.join(DATA_DIR, 'dummy_pkg_stale_pyc-0.1.0-py3.6.egg')
