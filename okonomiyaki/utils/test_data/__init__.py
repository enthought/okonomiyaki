...
PYTHON_CPYTHON_2_7_9_RH5_X86_64 = os.path.join(
    _HERE, "python-cpython-2.7.9+1-rh5_x86_64.runtime",
)
PYTHON_CPYTHON_2_7_9_WIN_X86 = os.path.join(
    _HERE, "python-cpython-2.7.9+1-win_x86.runtime",
)
PYTHON_CPYTHON_2_7_9_WIN_X86_64 = os.path.join(
    _HERE, "python-cpython-2.7.9+1-win_x86_64.runtime",
)
...
PYTHON_CPYTHON_2_7_10_WIN_X86 = os.path.join(
    _HERE, "python-cpython-2.7.10+1-win_x86.runtime",
)
...
PYTHON_PYPY_2_6_0_RH5_X86_64 = os.path.join(
    _HERE, "python-pypy-2.6.0+1-rh5_x86_64.runtime",
)
