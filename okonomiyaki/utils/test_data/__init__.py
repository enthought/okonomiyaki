...
# 3.14.0
PYTHON_CPYTHON_3_14_0_RH10_X86_64 = os.path.join(
    _HERE, 'cpython-3.14.0+1-rh10_x86_64-gnu.runtime',)
...
_RH10_X86_64_cp314 = os.path.join(_HERE, 'eggs', 'rh10_x86_64', 'cp314')

NOSE_1_3_4_RH10_X86_64_cp314 = os.path.join(_RH10_X86_64_cp314, 'nose-1.3.4-1.egg')
MKL_10_3_RH10_X86_64_cp314 = os.path.join(_RH10_X86_64_cp314, 'MKL-10.3-1.egg')
NUMPY_1_9_2_RH10_X86_64_cp314 = os.path.join(_RH10_X86_64_cp314, 'numpy-1.9.2-1.egg')

_RH10_ARM64_cp314 = os.path.join(_HERE, 'eggs', 'rh10_arm64', 'cp314')

NOSE_1_3_4_RH10_ARM64_cp314 = os.path.join(_RH10_ARM64_cp314, 'nose-1.3.4-1.egg')
MKL_10_3_RH10_ARM64_cp314 = os.path.join(_RH10_ARM64_cp314, 'MKL-10.3-1.egg')
NUMPY_1_9_2_RH10_ARM64_cp314 = os.path.join(_RH10_ARM64_cp314, 'numpy-1.9.2-1.egg')
...
CP314_EGGS = [
    NOSE_1_3_4_RH10_X86_64_cp314,
    MKL_10_3_RH10_X86_64_cp314,
    NUMPY_1_9_2_RH10_X86_64_cp314,
    NOSE_1_3_4_RH10_ARM64_cp314,
    MKL_10_3_RH10_ARM64_cp314,
    NUMPY_1_9_2_RH10_ARM64_cp314,
