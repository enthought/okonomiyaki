...
PYTHON_CPYTHON_2_7_9_RH5_X86_64 = os.path.join(
    _HERE, "python-cpython-2.7.9+1-rh5_x86_64-none.runtime",
)
PYTHON_CPYTHON_2_7_9_WIN_X86 = os.path.join(
    _HERE, "python-cpython-2.7.9+1-win_x86-msvc2008.runtime",
)
PYTHON_CPYTHON_2_7_9_WIN_X86_64 = os.path.join(
    _HERE, "python-cpython-2.7.9+1-win_x86_64-msvc2008.runtime",
)
PYTHON_CPYTHON_2_7_10_RH5_X86_64 = os.path.join(
    _HERE, "python-cpython-2.7.10+1-rh5_x86_64-none.runtime",
)
PYTHON_CPYTHON_2_7_10_WIN_X86 = os.path.join(
    _HERE, "python-cpython-2.7.10+1-win_x86-msvc2008.runtime",
)
PYTHON_CPYTHON_2_7_10_WIN_X86_64 = os.path.join(
    _HERE, "python-cpython-2.7.10+1-win_x86_64-msvc2008.runtime",
)
PYTHON_CPYTHON_2_7_10_RH5_X86_64_INVALID = os.path.join(
    _HERE, "python-cpython-2.7.10+1-rh5_x86_64-none.runtime.invalid",
)
PYTHON_PYPY_2_6_0_RH5_X86_64 = os.path.join(
    _HERE, "python-pypy-2.6.0+1-rh5_x86_64-none.runtime",
)
JULIA_DEFAULT_0_3_11_RH5_X86_64 = os.path.join(
    _HERE, "julia-default-0.3.11+1-rh5_x86_64-none.runtime",
)
JULIA_DEFAULT_0_3_11_WIN_X86_64 = os.path.join(
    _HERE, "julia-default-0.3.11+1-win_x86_64-mingw.runtime",
)
R_DEFAULT_3_0_0_RH5_X86_64 = os.path.join(
    _HERE, "r-default-3.0.0+1-rh5_x86_64-none.runtime",
)
